...
class Kipbase extends MY_Controller
{
    ...
    */
    ...
    {
        parent::__construct();
        $this->load->model('Kipbase_model', 'kip_model');
    }
    ...
    */
    function index()
    {
        ...
        $data['Kip_list'] = $this->kip_model->fetch_pips();
        ...
        $this->load->view('jaring/kip/content', $data);
    ...
    */
    function import_excel()
    {
        ...
        if (isset($_FILES['uploadFile']['name']) && in_array($_FILES['uploadFile']['type'], $file_mimes)) {
            ...
            if ($array_data != '') {
                $this->kip_model->insert_pip_batch($array_data);
            }
